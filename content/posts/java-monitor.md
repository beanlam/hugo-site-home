...
date: 2018-09-12T18:24:59+08:00
categories : ["java"]
---

# monitor的概念
管程，英文是 Monitor，也常被翻译为“监视器”，monitor 不管是翻译为“管程”还是“监视器”，都是比较晦涩的，通过翻译后的中文，并无法对 monitor 达到一个直观的描述。
在[《操作系统同步原语》](https://www.beanlam.me/2018/sync-primitive/) 这篇文章中，介绍了操作系统在面对  进程/线程 间同步的时候，所支持的一些同步原语，其中 semaphore 信号量 和 mutex 互斥量是最重要的同步原语。
...
![monitor object](/assets/java-monitor/monitorobject.jpg)
